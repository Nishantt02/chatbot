...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  // ✅ ALWAYS ensure chats is an array
  ...
  return (
    ...
    >
          ...
          {safeChats.length > 0 ? (
            safeChats.map((chat) => (
              ...
              >
                ...
                >
                  <span>
                    {(chat?.latestMessage || "New chat").slice(0, 38)}
                    {chat?.latestMessage?.length > 38 ? "..." : ""}
                  </span>
                </button>
      ...
      <div className="absolute bottom-0 mb-6 w-full">
        <button
          className="bg-red-600 text-white text-xl px-3 py-2 rounded-md hover:bg-red-700 w-[90%]"
